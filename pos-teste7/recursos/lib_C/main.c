...
int main() {
    iniciar_tela();
    limpar_tela();
    /* desenhar_sprite(reg,x,y,offset,sp); */

    //desenhar_sprite(5, 270, 130, 5, 1);
    ...
    */
    ...
    //ler_matriz(5,5,letraT,7);        
    //ler_matriz(5,5,letraE,7);
    //ler_matriz(5,5,letraI,7);
    //ler_matriz(5,5,letraR,2);
        for ( i = 0; i < 5; i++) {
        for (j = 0; j < 5; j++) {
            matriz[10 + i][30 + j] = letraT[i][j]; // T
            matriz[10 + i][36 + j] = letraE[i][j]; // E
...
void definirLetraP(char matriz[5][5]) {
    matriz[0][0] = 1; matriz[0][1] = 1; matriz[0][2] = 1;       // Parte superior do "P"
    matriz[1][0] = 1;                 matriz[1][2] = 1;         // Lado direito do topo
    matriz[2][0] = 1; matriz[2][1] = 1; matriz[2][2] = 1;       // Centro do "P"
    matriz[3][0] = 1;                                         // Tronco
    matriz[4][0] = 1;                                         // Tronco
}
